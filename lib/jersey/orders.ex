defmodule Jersey.Orders do
  ...
  alias Jersey.Repo
  alias Jersey.Orders.{Order, OrderItem}
  ...
  defdelegate set_post_cost_if_possible(changeset), to: Order
