...
config :jersey, Jersey.Repo,
  username: "postgres",
  password: "postgres",
  hostname: "localhost",
  database: "jersey_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :jersey, JerseyWeb.Endpoint,
  ...
  secret_key_base: "k9n3BACiASXbmRJ68cSXxXdGcCpKYzQWHNFYY1R2nqoCdJmdd9hmFv8lMbnyOSS8",
  server: false

# In test we don't send emails
config :jersey, Jersey.Mailer, adapter: Swoosh.Adapters.Test
